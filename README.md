...
## 📋 要約
- 来期は認証基盤の刷新を最優先で進めることで合意
- QAリソースが不足しているため、外部委託を検討する
- 3月末までにMVPリリースを目指す方針
- **TODO**: 田中さんが来週金曜までにQA外部委託の見積もりを取得

## 💬 全文（話者分離済み）
[00:01 → 00:15] SPEAKER_00: 来期のロードマップだけど、認証基盤を先にやらない？今のままだとスケールしないし
[00:15 → 00:28] SPEAKER_01: 賛成。ただQAのリソースが足りてないから、外部委託も検討しよう
[00:28 → 00:35] SPEAKER_00: それいいね。じゃあ来週金曜までに見積もり出してもらえる？
[00:35 → 00:42] SPEAKER_01: 了解。あと3月末のMVPリリースは変わらずでいく？
[00:42 → 00:50] SPEAKER_00: うん、そこは死守で。認証が入れば他のチームもAPI使えるようになるし
...
```
